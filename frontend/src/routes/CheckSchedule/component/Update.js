    ...
    useEffect(() => {  
        if (reminder) {  
            form.setFieldsValue({  
                ...
                dosage: reminder.dosage, // Ambil dari reminder  
                description: reminder.description,  
                frequency: reminder.frequency, // Ambil dari reminder  
            ...
            <Row gutter={16}>
                ...
                <Col span={12}>
                    ...
                    <TimePicker
                        format={"HH:mm"}
                        style={{ width: "100%" }}
                        defaultValue={reminder && moment(reminder.reminder_time, "HH:mm:ss")}
                    />
                    </Form.Item>
